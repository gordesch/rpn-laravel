<x-admin.auth.layout title="Nouvel administrateur">
  <form action="{{ route('admin.register') }}" method="POST" class="bg-white overflow-hidden mt-8 sm:mx-auto sm:w-full sm:max-w-xl shadow sm:rounded-lg">
    @csrf
    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
      <h3 class="text-lg leading-6 font-medium text-gray-900">
        Nouvel administrateur du site
      </h3>
