<x-admin.auth.layout title="Modification du mot de passe" category="auth">
  <form action="{{ route('admin.password.update') }}" method="POST" class="bg-white overflow-hidden mt-8 sm:mx-auto sm:w-full sm:max-w-xl shadow sm:rounded-lg">
    @csrf
