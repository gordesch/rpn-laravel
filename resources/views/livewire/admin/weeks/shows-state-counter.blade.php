<span class="@if (!$shows_with_missing_data_count) hidden @endif inline-flex items-center ml-2 px-2.5 py-0.5 rounded-full text-xs font-medium leading-4 @if($selected === 'shows-state')  bg-indigo-200 text-indigo-500 @else bg-gray-200 text-gray-500 @endif">
