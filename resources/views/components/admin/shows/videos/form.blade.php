...
<div class="mt-8 border-t border-gray-200 pt-8 sm:mt-5 sm:pt-10 @if($show->is_local_language) mx-auto max-w-3xl @endif">
  <h3 class="text-lg leading-6 font-medium text-gray-900">
    @if ($show->is_local_language)
      Bande-annonce
    @else
      Bandes-annonces
    @endif
  ...
  <div class="grid grid-cols-1 gap-4 @if (!$show->is_local_language) lg:grid-cols-2 @endif">
