...
<div class="mb-8">
  <div class="sm:hidden">
    <select class="form-select block w-full">
      <option @if($selected === 'edit') selected @endif>Réglages</option>
      <option @if($selected === 'programmings.shows.edit') selected @endif>État des fiches</option>
      <option @if($selected === 'programmings.shows.index') selected @endif>Ressources newsletter</option>
      <option @if($selected === 'showings.index') selected @endif>Séances</option>
    </select>
  </div>
  <div class="hidden sm:block">
    <div class="border-b-2 border-gray-300">
      <nav class="flex -mb-px">
        <a href="{{ route('admin.weeks.edit', [$week]) }}" class="@if($selected === 'edit') border-indigo-500 text-indigo-600 focus:outline-none focus:text-indigo-800 focus:border-indigo-700 @else border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 @endif ml-8 group inline-flex items-center -mb-px py-4 px-1 border-b-4 font-medium text-sm leading-5">
          <svg class="-ml-0.5 mr-2 h-5 w-5 @if($selected === 'edit') text-indigo-500 @else text-gray-400 group-hover:text-gray-500 @endif" fill="currentColor" viewBox="0 0 20 20">
        ...
        <a href="{{ route('admin.weeks.programmings.shows.edit', [$week]) }}" class="@if($selected === 'programmings.shows.edit') border-indigo-500 text-indigo-600 focus:outline-none focus:text-indigo-800 focus:border-indigo-700 @else border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 @endif ml-8 group inline-flex items-center -mb-px py-4 px-1 border-b-4 font-medium text-sm leading-5">
          <svg class="-ml-0.5 mr-2 h-5 w-5 @if($selected === 'programmings.shows.edit') text-indigo-500 @else text-gray-400 group-hover:text-gray-500 @endif" fill="currentColor" viewBox="0 0 20 20">
        ...
        <a href="{{ route('admin.weeks.programmings.shows.index', [$week]) }}" class="@if($selected === 'programmings.shows.index') border-indigo-500 text-indigo-600 focus:outline-none focus:text-indigo-800 focus:border-indigo-700 @else border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 @endif ml-8 group inline-flex items-center -mb-px py-4 px-1 border-b-4 font-medium text-sm leading-5">
          <svg class="-ml-0.5 mr-2 h-5 w-5 @if($selected === 'programmings.shows.index') text-indigo-500 @else text-gray-400 group-hover:text-gray-500 @endif" fill="currentColor" viewBox="0 0 20 20">
        ...
        <a href="{{ route('admin.weeks.showings.index', [$week]) }}" class="@if($selected === 'programmings.showings.index') border-indigo-500 text-indigo-600 focus:outline-none focus:text-indigo-800 focus:border-indigo-700 @else border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 @endif ml-8 group inline-flex items-center -mb-px py-4 px-1 border-b-4 font-medium text-sm leading-5">
          <svg class="-ml-0.5 mr-2 h-5 w-5 @if($selected === 'programmings.showings.index') text-indigo-500 @else text-gray-400 group-hover:text-gray-500 @endif" fill="currentColor" viewBox="0 0 20 20">
