<x-public.layout title="Ce soir" subtitle="Séances après 18h30" category="showings">
        ...
        <table class="min-w-full">
          ...
          <tr>
            <th
              ...
              colspan="2">
              <a class="hover:text-gray-700" href="{{ route('showing.tonight', $date->subDay()->format('Y-m-d')) }}">
              ...
              <a class="hover:text-gray-700" href="{{ route('showing.tonight', $date->addDay()->format('Y-m-d')) }}">
                Le lendemain
                <span aria-hidden="true">→</span>
              </a>
            </th>
